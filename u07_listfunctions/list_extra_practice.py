...
for index_names in range(len(names)):
    print(names[index_names])
# Q2
# Print the full scores list using a for loop.
for index_scores in range(len(scores)):
    print(scores[index_scores])
# Q3
...
input_name = 'Aiden'
student_in_name = input_name in names
if student_in_name == True:
    print('Student found')
else:
...
charlie_index = names.index("Charlie")
print(scores[charlie_index])
...
student_input = 'Aiden'
# student_in_name = student_input in names

if student_input not in names:
# if student_in_name == False:
    print('Student not found')
else:
    index_student = names.index(student_input)
    print(scores[index_student])
...
# Bella : 92
# Charlie : 85
for student_index in range(len(names)):

    print(f"{ names[student_index] } : {scores[student_index]}")

    # print(names[student_index])
    # print(f'student_index is {student_index}')
    # score = scores[student_index]
