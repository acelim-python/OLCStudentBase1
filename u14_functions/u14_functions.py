...
def calculate_days(date):
    ...
    days_elapsed = ((month-1) * 30) + day    

    return days_elapsed

# days_passed = calculate_days("01-02")
...
def days_difference(today,expiry):
    today_days_passed = calculate_days(today)
    print(today_days_passed)
    expiry_days_passed = calculate_days(expiry)
    print(expiry_days_passed)

    diff = expiry_days_passed - today_days_passed

    return diff
    # if expiry_days_passed < today_days_passed:
    #     print('Item is expired')
    #     print(f'Days expired = ')
    # elif today_days_passed < expiry_days_passed:
