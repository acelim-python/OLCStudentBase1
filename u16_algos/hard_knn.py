...
#--------------------------------------------------------
import math
weather_temperature = float(input('Enter temperature : '))
weather_humidity = int(input('Enter humidity :'))
weather_wind_speed = int(input('Enter wind speed : '))

shortest_distance = 99999
predicted_weather = " "

for weather_code in weather_records:
   weather =  weather_records[weather_code]
   temperature = weather[0]
   humidity = weather[1]
   wind_speed = weather[2]
   weather_prediction = weather[3]
   distance = math.sqrt((temperature - weather_temperature)**2+(humidity - weather_humidity)**2+(wind_speed - weather_wind_speed)**2)
   if distance < shortest_distance:
       shortest_distance = distance
       predicted_weather = weather_prediction
       day_id = weather_code
# print(shortest_distance)
print(f"The predicted weather for the set of inputs is {predicted_weather}")
print(f"The nearest day_id is {day_id}")
