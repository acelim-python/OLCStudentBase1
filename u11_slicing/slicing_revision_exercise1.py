...
'''
## Write and test your code here
check_first_letter = 'STFG'
check_len = 8
def validate_nric(nric):
    if nric[0] not in ["S", "T", "F", "G"]:
        print("First character must be S ,T, F or G")
        return False
    elif not nric[-1].isalpha():
        print("Last character must be alphabet.")
        return False
    ####
    # elif ....
    else:
    ...
    # first_letter = nric[0]
    # print(first_letter in check_first_letter)

    # letter = nric[-1]
    # valid = letter.isupper()
    # if valid == True:
    #     return 'True'
    # else:
    #     return 'False'
