...
# Write your code below.
# ---------------------------------------------------------
# with open("q3_dairy.txt","a") as file:
#     file.write("\nI also revised Python at night.")

# with open("q3_dairy.txt", "r") as file:
#     content = file.read()
# print(content)
...
print(fruits)
print(f'Total number of fruits is {len(fruits)}')
...
with open("proper_names.txt", "w") as file:
